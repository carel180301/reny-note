...
class AsumController extends Controller
{
    ...
    public function edit(Asum $asum){
        return view('asums.edit', ['asum' => $asum]);
    }

    public function update(Asum $asum, Request $request){
        $data = $request->validate([
            'nama_tertanggung' => 'required',
            'posisi' => 'required',
            'cob' => 'required',
    ...
    public function destroy(Asum $asum){
        $asum->delete();
    ...
    public function upload(Request $request)
    {
        ...
        Excel::import(new AsumsImport, $request->file('file'));
