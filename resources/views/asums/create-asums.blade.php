...
<body>
    ...
    <form method="post" action="{{ route('asums.store') }}">
        ...
        <div>
            ...
            <input type="text" name="tanggal_polis" placeholder="Tanggal Polis" />
        </div>

        <div>
            <label>Nomor STGR: </label> 
            <input type="text" name="nomor_stgr" placeholder="Tanggal STGR" />
        </div>

        <div>
            <label>Tanggal STGR: </label> 
            <input type="date" name="tanggal_stgr" placeholder="tanggal_stgr" />
        </div>
        ...
        <div>
            ...
            <select name="posisi" class="form-select">
                <option value="" disabled selected>Status Sistem</option>
        ...
        <div>
            ...
            <input type="text" name="tanggal_register_sistem" placeholder="Tanggal Register Sistem" />
        </div>
        ...
        <div>
            <label>Nomor Claim Statement: </label> 
            <input type="text" name="nomor_claim_settelement" placeholder="Nomor Claim Settelement" />
        </div>

        <div>
            <label>Tanggal Claim Statement: </label> 
            <input type="date" name="tanggal_claim_settelement" placeholder="Tanggal Claim Settelement" />
        </div>
        ...
        <div>
            ...
            <input type="date" name="tanggal_surat_persetujuan_atau_penolakan" placeholder="Nomor Surat Persetujuan Atau Penolakan" />
        </div>
