...
<body>
    ...
    <div>
        <table class="table table-hover">
            ...
            @foreach($bris as $bri)
                <tr>
                    ...
                    <td>
                        <div class="d-flex gap-2 align-items-center">
                              <!-- SEND EMAIL -->
                            <button class="btn p-0 text-primary" onclick="sendEmail({{ $bri->id }})">
                            ...
                            <!-- DELETE -->
                            <form method="POST" action="{{ route('bri.destroy', $bri) }}">
                                @csrf
                                @method('delete')
                ...
                <!-- EDIT MODAL -->
                <div class="modal fade" id="editBriModal{{ $bri->id }}">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form method="POST" action="{{ route('bri.update', $bri) }}">
                                    @csrf
                                    @method('PUT')
    ...
    <div class="modal fade" id="addBriModal">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Add New BRI</h5>
                    <button class="btn-close" data-bs-dismiss="modal"></button>
                </div>

                <div class="modal-body">
                    <form method="POST" action="{{ route('bri.store') }}">
                        @csrf
                        <div class="mb-3">
                            <label class="form-label">Unit</label>
